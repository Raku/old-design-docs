...
though each differ in their exact formulation of the contents of a string:
    ...
    say "ẛ̣".compose.chars;       # OUTPUT: 2 (NFC, ẛ + ̣)
    say "ẛ̣".decompose.chars;     # OUTPUT: 3 (NFD, ſ + ̣+ ̇)
    say "ẛ̣".compose(:k).chars;   # OUTPUT: 1 (NFKC, ṩ)
    say "ẛ̣".decompose(:k).chars; # OUTPUT: 3 (NFKD, s + ̣+ ̇)
...
specific string. You must convert to one of the codepoint-based types for an
