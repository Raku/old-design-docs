...
=head2 X::Parameter::MultipleTypeConstraints
...
=head2 X::Method::Private::Permission
...
=head2 X::Method::Private::Unqualified
...
=head2 X::Syntax::NegatedPair

Thrown when a negated pair has a value, for exaple C<:!foo($val)>.

    my class X::Syntax::NegatedPair does X::Syntax {
        method message() { 'Argument not allowed on negated pair' }
    }

=head2 X::Syntax::Variable::Numeric
...
=head2 X::Syntax::Variable::Twigil
...
=head2 X::Syntax::Variable::IndirectDeclaration
...
=head2 X::Syntax::Augment::WithoutMonkeyTyping
...
=head2 X::Syntax::Comment::Embedded
...
=head2 X::Syntax::Pod::BeginWithoutIdentifier
...
=head2 X::Syntax::Pod::BeginWithoutEnd
...
=head2 X::Syntax::SigilWithoutName
...
=head2 X::Syntax::Self::WithoutObject
...
=head2 X::Syntax::Number::RadixOutOfRange
...
=head2 X::Syntax::Signature::InvocantMarker
...
=head2 X::Syntax::Extension::Category
...
=head2 X::Syntax::InfixInTermPosition
...
=head2 X::Declaration::Scope::Multi
...
=head2 X::Inheritance::Unsupported
