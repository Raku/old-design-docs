...
this may also be a L<Parcel> to indicate a multi-level classification.  In
...
=item push
 ...
 multi method push ( @array: *@values, :bind --> Array ) is export

Adds all the values to the end of C<@array> eagerly.  Returns the modified
array.

The optional C<:bind> parameter indicates whether the values should be bound:
this will generally reduce the amount of memory needed.  By default, values
will be copied.
...
=item push
 ...
 multi method push ( %hash: *@values, :bind --> Hash ) is export
