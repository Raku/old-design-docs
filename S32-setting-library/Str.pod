...
=item split
 ...
 our List multi method split ( Str $input: Regex $delimiter, Int $limit = *, Bool :$all = False) is export
...
=item comb
 ...
 our List multi method comb ( Str $input: Regex $matcher = /\S+/, Int $limit = * ) is export
