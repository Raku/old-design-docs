...
Denote a VM targetted by L</rakudo>. Can be L</MoarVM>, L</JVM> or L</Parrot>.
...
of a L</constructor> L</expression>. For an example, see the L</Fat comma>.
...
L<Keep It Simple, Stupid!|https://en.wikipedia.org/wiki/KISS_principle>, a famous motto in cpomuter science.
