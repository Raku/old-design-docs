...
L</Rakudo> provides interoperability with languages which compilers
...
languages including Perl 6 have L</compiler>s targeting the JVM.
...
A native value is an L</Int>, L</Num>, L</Str>.
...
A category has a precedence, an arity, and can be L</fiddly>, L</iffy>, L</diffy>.
...
postcircumfix operator C<[0]> where C<0> is the postcircumfixed subexpression.
...
documenting, discussing, lurking or idling.  See also L<here|http://en.wikipedia.org/wiki/Small_matter_of_programming>.
