...
involves a NFA, whiler the latter involves the recursive engine. That's why the former is faster than the latter.
...
Defining a slang has a cost because it usually involves generating new C</NFA>s table but except for
