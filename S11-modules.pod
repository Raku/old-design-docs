...
called "META.info".  The existence of this file indicates that this
...
The META.info file is a JSON-file that must at least contain a C<name>,
C<version> and C<description> section.
...
To indicate a dependency on a version of Perl, simply use the version string
that indicates the version of the interpreter:

  "depends" : [
    "v6.0.1"
  ]

would only allow installation of this distribution on Perl 6.0.1 and higher.
