...
In L</META6.json>, a quoted string that one would pass to C<Version.new>, e.g.
"6.c". This B<should not> be prefixed with "v" (unless your package has a really
weird versioning scheme, but please try not to do that).
