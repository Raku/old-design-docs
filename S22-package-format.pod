...
=item * 6PAN-network; this is an actual network based on the cpan6 software (see above).  It also 
is not documented here.  

=item * 6PAN-packager; this is a piece of software that starts with what it can get on 6PAN-network, and 
