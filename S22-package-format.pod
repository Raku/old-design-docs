...
contains the C<CompUnitRepo> class type object, the second contains the
location string, and the third contains a C<Hash> of the optional named
parameters.  Throws an exception if anything went wrong with parsing.
