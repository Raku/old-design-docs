...
=item * ???A; this is an actual network based on the cpan6 software (see above).  It also 
is not documented here.  

=item * ???B; this is a piece of software that starts with what it can get on ???A, and 
