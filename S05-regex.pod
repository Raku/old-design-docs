...
=head1 Matching against literal True/False

To prevent mistakes with testing againts truthiness, a compile error should
occur when an attempt is made to smartmatch against a literal True or False.
