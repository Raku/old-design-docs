...
However, the I<default> ones replace the Perl 5 $| variable with three new variables.  
...
Attempts to open the handle.  Depending on the implementation, this could be an open() 
