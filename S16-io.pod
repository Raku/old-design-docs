...
class	IO::FileSystem does IO::Streamable {
	...
	has	IO::FileSystemEntry $.basepath; # The Unix mount point, or Windows drive letter, or whatever
...
The $.owningObject attribute of FileSystemEntryACL shows what the ACL is set on.  On a 
