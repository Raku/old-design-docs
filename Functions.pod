...
=item pick
 ...
 our Lazy multi pick ( Int $num, *@values , Bool :$repl )
 our Lazy multi pick ( Whatever, *@values , Bool :$repl )
...
Unicode strings in a binary form. Without decomposing first, two
Unicode strings may contain the same text, but not the same binary
data. The decomposition of a string is performed according to tables
