...
zip takes any number of arrays and returns a single (lazily evaluated)
list of their contents, merged by index. In other words,

 @one = 1, 2;
 @two = 3, 4;
 @three = 4, 5;
 @all = zip @one, @two, @three;

will place into C<@all>, the list, C<1,3,4,2,4,5>. The name is meant to be
...
=item each
 ...
 our Iterator multi Container::each(Bool :$parity = False, Container *@containers)
