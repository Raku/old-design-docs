...
=item chop
 ...
 our Str method method chop ( Str  $string: ) is export
...
=item chomp
 ...
 our Str method method chomp ( Str $string: ) is export
...
[I don't think this should be a built-in anymore. -law]

 our Str multi method p5crypt ( Str $plaintext: Str $salt ) is export(:P5)
