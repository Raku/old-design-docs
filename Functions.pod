...
=item zip
 ...
 our Iterator multi infix:Container::Z ( Bool :$shortest, Bool :$finite, *@@list )
...
you can use the C<[~]> reduce operator.
...
the substring is returned. If the substring is not found, then C<-1> is
returned. [Conjecture: Could it be "-1 but Undef" or something?]
