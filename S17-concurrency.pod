...
Produces a C<Promise> that will be kept for the B<next> (or the B<last> value
if C<:last> is specified) of the given C<Supply>, or will be broken when the
C<Supply> is done before a value is produced.
