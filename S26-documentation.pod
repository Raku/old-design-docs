...
of cells. If a row has less cells then the row with the maximum number of
cells, sufficient empty cells will be added to the short row to make
all table rows equal in cells.
